...
const Introduction: React.FC = () => {
  return (
    <section className="pb-2 lg:pb-2 xl:pb-4 pt-52">
      ...
      <p>
        - Hub star программ дээр байршуулсан үйлчилгээг хэрэглэгч тус бүрээр харах боломжтой бөгөөд
        шүүлтүүр, хайлт ашиглан хэрэгцээт үйлчилгээгээ олох боломжтой.
      </p>
      <p>
        - Та өөрийн хэрэгцээтэй байгаа үйлчилгээг байршуулсан үйлчилгээнд нэвтэрч үйлчилгээ захиалах
        товчийг дарснаар та үйлчилгээ байршуулагчтай хэрэглэгчидтэй холбогдох боломжтой болно.
      </p>
      <p>
        - Мөн та үйлчилгээ байршуулагчийн профайлыг үзсэнээр хийж гүйцэтгэсэн үйлчилгээний түүхийг
        харах боломжтой.
      </p>
      <h1>Байршуулсан үйлчилгээ</h1>
      <p>
      ...
      <p>
        - Хийгдэж буй ажлын хэсэгт байршсан ажлын үйлчилгээний төлөв хэсгийн төлөв солих товчлуурыг
        дарна.
      </p>
      <p>
        - Үйлчилгээний төлөв солих хэсгийн нэмэлт цонхонд ажил дуусгавар болгосон тайлбар, үйлчилгээ
        үзүүлэгчийг дүгнэсэн 0-10 оноо бүхий 5 одноос үнэлгээ өгч хадгалснаар ажил үйлчилгээний түүх
        хэсэгт шилжинэ.
      </p>
      <h1>Зөвлөмжүүд</h1>
      <p>- Хэрэглэгчид өөрт шаардлагатай зөвлөмжүүдийг авах боломжтой.</p>
      <p>
        - Бүтээн байгуулалтын салбарын  ажил хийхэд  зөвшөөрөл өгөх , хяналт шалгалт хийх, заавар
        зөвлөмж өгөх зэрэг үйл ажиллагааг хариуцдаг төрийн болон төрийн бус байгууллагууд хувийн 
        хэвшлийн байгууллагууд.
      </p>
      <p>
        - Бүтээн байгуулалтын ажил хийж гүйцэтгэх жишиг заавар зөвлөмж, арга аргачлал, технологийн
        карт, видео бичлэг.
      </p>
      <p>
