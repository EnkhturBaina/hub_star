...
const Introduction: React.FC = () => {
  ...
  useEffect(() => {
    const handleScroll = () => {
      const sectionElements = appSections.map(item => document.getElementById(item.id));
  ...
  return (
    <section className="pb-2 lg:pb-2 xl:pb-4 pt-16">
      <div className="flex flex-row pt-6 mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="mx-auto max-w-sm top-20 sticky h-screen">
          ...
          {appSections.map((item, index) => (
            <Button
              ...
              className={classNames(
                'my-1 font-bold w-full',
                activeSection == item.id ? 'bg-mainColor text-white' : ''
              )}
