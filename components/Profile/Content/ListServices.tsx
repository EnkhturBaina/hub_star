...
const ListServices = ({ servicesData }: { servicesData: any }) => {
  return (
    <div className="grid grid-cols-1 gap-3 bg-mainProfileCardBg">
      {servicesData.map((blog: Services, index: any) => (
        <motion.div
          ...
          viewport={{ once: true }}
          className="animate_top flex h-25 flex-row rounded-lg bg-white shadow-solid-8"
          key={"list" + index}
        >
